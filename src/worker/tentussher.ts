 ...
 * ALGEBRAIC[65] is ddt_Ca_i_total in component calcium_dynamics (millimolar_per_millisecond).
 * ALGEBRAIC[66] is ddt_Ca_sr_total in component calcium_dynamics (millimolar_per_millisecond).
 * ALGEBRAIC[67] is f_JCa_i_free in component calcium_dynamics (dimensionless).
 * ALGEBRAIC[68] is f_JCa_sr_free in component calcium_dynamics (dimensionless).
...
{
ALGEBRAIC[8] = 1.00000/(1.00000+Math.exp((STATES[0]+20.0000)/7.00000));
ALGEBRAIC[21] =  1125.00*Math.exp(- Math.pow(STATES[0]+27.0000, 2.00000)/240.000)+80.0000+165.000/(1.00000+Math.exp((25.0000 - STATES[0])/10.0000));
RATES[11] = (ALGEBRAIC[8] - STATES[11])/ALGEBRAIC[21];
ALGEBRAIC[10] = 1.00000/(1.00000+Math.exp((STATES[0]+20.0000)/5.00000));
ALGEBRAIC[23] =  85.0000*Math.exp(- Math.pow(STATES[0]+45.0000, 2.00000)/320.000)+5.00000/(1.00000+Math.exp((STATES[0] - 20.0000)/5.00000))+3.00000;
RATES[13] = (ALGEBRAIC[10] - STATES[13])/ALGEBRAIC[23];
ALGEBRAIC[11] = 1.00000/(1.00000+Math.exp((20.0000 - STATES[0])/6.00000));
ALGEBRAIC[24] =  9.50000*Math.exp(- Math.pow(STATES[0]+40.0000, 2.00000)/1800.00)+0.800000;
RATES[14] = (ALGEBRAIC[11] - STATES[14])/ALGEBRAIC[24];
ALGEBRAIC[12] = (STATES[3]<0.000350000 ? 1.00000/(1.00000+Math.pow(STATES[3]/0.000350000, 6.00000)) : 1.00000/(1.00000+Math.pow(STATES[3]/0.000350000, 16.0000)));
ALGEBRAIC[25] = (ALGEBRAIC[12] - STATES[16])/CONSTANTS[33];
RATES[16] = (ALGEBRAIC[12]>STATES[16]&&STATES[0]>- 60.0000 ? 0.00000 : ALGEBRAIC[25]);
ALGEBRAIC[1] = 1.00000/(1.00000+Math.exp((- 26.0000 - STATES[0])/7.00000));
ALGEBRAIC[14] = 450.000/(1.00000+Math.exp((- 45.0000 - STATES[0])/10.0000));
ALGEBRAIC[27] = 6.00000/(1.00000+Math.exp((STATES[0]+30.0000)/11.5000));
ALGEBRAIC[36] =  1.00000*ALGEBRAIC[14]*ALGEBRAIC[27];
RATES[4] = (ALGEBRAIC[1] - STATES[4])/ALGEBRAIC[36];
ALGEBRAIC[2] = 1.00000/(1.00000+Math.exp((STATES[0]+88.0000)/24.0000));
ALGEBRAIC[15] = 3.00000/(1.00000+Math.exp((- 60.0000 - STATES[0])/20.0000));
ALGEBRAIC[28] = 1.12000/(1.00000+Math.exp((STATES[0] - 60.0000)/20.0000));
ALGEBRAIC[37] =  1.00000*ALGEBRAIC[15]*ALGEBRAIC[28];
RATES[5] = (ALGEBRAIC[2] - STATES[5])/ALGEBRAIC[37];
ALGEBRAIC[3] = 1.00000/(1.00000+Math.exp((- 5.00000 - STATES[0])/14.0000));
ALGEBRAIC[16] = 1100.00/ Math.pow((1.00000+Math.exp((- 10.0000 - STATES[0])/6.00000)), 1.0 / 2);
ALGEBRAIC[29] = 1.00000/(1.00000+Math.exp((STATES[0] - 60.0000)/20.0000));
ALGEBRAIC[38] =  1.00000*ALGEBRAIC[16]*ALGEBRAIC[29];
RATES[6] = (ALGEBRAIC[3] - STATES[6])/ALGEBRAIC[38];
ALGEBRAIC[4] = 1.00000/Math.pow(1.00000+Math.exp((- 56.8600 - STATES[0])/9.03000), 2.00000);
ALGEBRAIC[17] = 1.00000/(1.00000+Math.exp((- 60.0000 - STATES[0])/5.00000));
ALGEBRAIC[30] = 0.100000/(1.00000+Math.exp((STATES[0]+35.0000)/5.00000))+0.100000/(1.00000+Math.exp((STATES[0] - 50.0000)/200.000));
ALGEBRAIC[39] =  1.00000*ALGEBRAIC[17]*ALGEBRAIC[30];
RATES[7] = (ALGEBRAIC[4] - STATES[7])/ALGEBRAIC[39];
ALGEBRAIC[5] = 1.00000/Math.pow(1.00000+Math.exp((STATES[0]+71.5500)/7.43000), 2.00000);
ALGEBRAIC[18] = (STATES[0]<- 40.0000 ?  0.0570000*Math.exp(- (STATES[0]+80.0000)/6.80000) : 0.00000);
ALGEBRAIC[31] = (STATES[0]<- 40.0000 ?  2.70000*Math.exp( 0.0790000*STATES[0])+ 310000.*Math.exp( 0.348500*STATES[0]) : 0.770000/( 0.130000*(1.00000+Math.exp((STATES[0]+10.6600)/- 11.1000))));
ALGEBRAIC[40] = 1.00000/(ALGEBRAIC[18]+ALGEBRAIC[31]);
RATES[8] = (ALGEBRAIC[5] - STATES[8])/ALGEBRAIC[40];
ALGEBRAIC[6] = 1.00000/Math.pow(1.00000+Math.exp((STATES[0]+71.5500)/7.43000), 2.00000);
ALGEBRAIC[19] = (STATES[0]<- 40.0000 ? (( ( - 25428.0*Math.exp( 0.244400*STATES[0]) -  6.94800e-06*Math.exp( - 0.0439100*STATES[0]))*(STATES[0]+37.7800))/1.00000)/(1.00000+Math.exp( 0.311000*(STATES[0]+79.2300))) : 0.00000);
ALGEBRAIC[32] = (STATES[0]<- 40.0000 ? ( 0.0242400*Math.exp( - 0.0105200*STATES[0]))/(1.00000+Math.exp( - 0.137800*(STATES[0]+40.1400))) : ( 0.600000*Math.exp( 0.0570000*STATES[0]))/(1.00000+Math.exp( - 0.100000*(STATES[0]+32.0000))));
ALGEBRAIC[41] = 1.00000/(ALGEBRAIC[19]+ALGEBRAIC[32]);
RATES[9] = (ALGEBRAIC[6] - STATES[9])/ALGEBRAIC[41];
ALGEBRAIC[7] = 1.00000/(1.00000+Math.exp((- 5.00000 - STATES[0])/7.50000));
ALGEBRAIC[20] = 1.40000/(1.00000+Math.exp((- 35.0000 - STATES[0])/13.0000))+0.250000;
ALGEBRAIC[33] = 1.40000/(1.00000+Math.exp((STATES[0]+5.00000)/5.00000));
ALGEBRAIC[42] = 1.00000/(1.00000+Math.exp((50.0000 - STATES[0])/20.0000));
ALGEBRAIC[45] =  1.00000*ALGEBRAIC[20]*ALGEBRAIC[33]+ALGEBRAIC[42];
RATES[10] = (ALGEBRAIC[7] - STATES[10])/ALGEBRAIC[45];
ALGEBRAIC[9] = 1.00000/(1.00000+Math.pow(STATES[3]/0.000325000, 8.00000));
ALGEBRAIC[22] = 0.100000/(1.00000+Math.exp((STATES[3] - 0.000500000)/0.000100000));
ALGEBRAIC[34] = 0.200000/(1.00000+Math.exp((STATES[3] - 0.000750000)/0.000800000));
...
ALGEBRAIC[58] = (( (( CONSTANTS[21]*CONSTANTS[10])/(CONSTANTS[10]+CONSTANTS[22]))*STATES[2])/(STATES[2]+CONSTANTS[23]))/(1.00000+ 0.124500*Math.exp(( - 0.100000*STATES[0]*CONSTANTS[2])/( CONSTANTS[0]*CONSTANTS[1]))+ 0.0353000*Math.exp(( - STATES[0]*CONSTANTS[2])/( CONSTANTS[0]*CONSTANTS[1])));
ALGEBRAIC[13] =  (( CONSTANTS[0]*CONSTANTS[1])/CONSTANTS[2])*Math.log(CONSTANTS[11]/STATES[2]);
ALGEBRAIC[53] =  CONSTANTS[16]*Math.pow(STATES[7], 3.00000)*STATES[8]*STATES[9]*(STATES[0] - ALGEBRAIC[13]);
ALGEBRAIC[54] =  CONSTANTS[17]*(STATES[0] - ALGEBRAIC[13]);
ALGEBRAIC[59] = ( CONSTANTS[24]*( Math.exp(( CONSTANTS[27]*STATES[0]*CONSTANTS[2])/( CONSTANTS[0]*CONSTANTS[1]))*Math.pow(STATES[2], 3.00000)*CONSTANTS[12] -  Math.exp(( (CONSTANTS[27] - 1.00000)*STATES[0]*CONSTANTS[2])/( CONSTANTS[0]*CONSTANTS[1]))*Math.pow(CONSTANTS[11], 3.00000)*STATES[3]*CONSTANTS[26]))/( (Math.pow(CONSTANTS[29], 3.00000)+Math.pow(CONSTANTS[11], 3.00000))*(CONSTANTS[28]+CONSTANTS[12])*(1.00000+ CONSTANTS[25]*Math.exp(( (CONSTANTS[27] - 1.00000)*STATES[0]*CONSTANTS[2])/( CONSTANTS[0]*CONSTANTS[1]))));
RATES[2] = ( - (ALGEBRAIC[53]+ALGEBRAIC[54]+ 3.00000*ALGEBRAIC[58]+ 3.00000*ALGEBRAIC[59])*CONSTANTS[3])/( CONSTANTS[4]*CONSTANTS[2]);
ALGEBRAIC[26] =  (( CONSTANTS[0]*CONSTANTS[1])/CONSTANTS[2])*Math.log(CONSTANTS[10]/STATES[1]);
ALGEBRAIC[47] = 0.100000/(1.00000+Math.exp( 0.0600000*((STATES[0] - ALGEBRAIC[26]) - 200.000)));
ALGEBRAIC[48] = ( 3.00000*Math.exp( 0.000200000*((STATES[0] - ALGEBRAIC[26])+100.000))+ 1.00000*Math.exp( 0.100000*((STATES[0] - ALGEBRAIC[26]) - 10.0000)))/(1.00000+Math.exp( - 0.500000*(STATES[0] - ALGEBRAIC[26])));
ALGEBRAIC[49] = ALGEBRAIC[47]/(ALGEBRAIC[47]+ALGEBRAIC[48]);
ALGEBRAIC[50] =  CONSTANTS[13]*ALGEBRAIC[49]* Math.pow((CONSTANTS[10]/5.40000), 1.0 / 2)*(STATES[0] - ALGEBRAIC[26]);
ALGEBRAIC[57] =  CONSTANTS[20]*STATES[14]*STATES[13]*(STATES[0] - ALGEBRAIC[26]);
ALGEBRAIC[51] =  CONSTANTS[14]* Math.pow((CONSTANTS[10]/5.40000), 1.0 / 2)*STATES[4]*STATES[5]*(STATES[0] - ALGEBRAIC[26]);
ALGEBRAIC[35] =  (( CONSTANTS[0]*CONSTANTS[1])/CONSTANTS[2])*Math.log((CONSTANTS[10]+ CONSTANTS[9]*CONSTANTS[11])/(STATES[1]+ CONSTANTS[9]*STATES[2]));
ALGEBRAIC[52] =  CONSTANTS[15]*Math.pow(STATES[6], 2.00000)*(STATES[0] - ALGEBRAIC[35]);
ALGEBRAIC[55] = ( (( CONSTANTS[18]*STATES[10]*STATES[11]*STATES[12]*4.00000*STATES[0]*Math.pow(CONSTANTS[2], 2.00000))/( CONSTANTS[0]*CONSTANTS[1]))*( STATES[3]*Math.exp(( 2.00000*STATES[0]*CONSTANTS[2])/( CONSTANTS[0]*CONSTANTS[1])) -  0.341000*CONSTANTS[12]))/(Math.exp(( 2.00000*STATES[0]*CONSTANTS[2])/( CONSTANTS[0]*CONSTANTS[1])) - 1.00000);
ALGEBRAIC[44] =  (( 0.500000*CONSTANTS[0]*CONSTANTS[1])/CONSTANTS[2])*Math.log(CONSTANTS[12]/STATES[3]);
ALGEBRAIC[56] =  CONSTANTS[19]*(STATES[0] - ALGEBRAIC[44]);
ALGEBRAIC[61] = ( CONSTANTS[32]*(STATES[0] - ALGEBRAIC[26]))/(1.00000+Math.exp((25.0000 - STATES[0])/5.98000));
ALGEBRAIC[60] = ( CONSTANTS[30]*STATES[3])/(STATES[3]+CONSTANTS[31]);
ALGEBRAIC[0] = (VOI -  Math.floor(VOI/CONSTANTS[6])*CONSTANTS[6]>=CONSTANTS[5]&&VOI -  Math.floor(VOI/CONSTANTS[6])*CONSTANTS[6]<=CONSTANTS[5]+CONSTANTS[7] ? CONSTANTS[8] : 0.00000);
...
ALGEBRAIC[62] =  (( CONSTANTS[34]*Math.pow(STATES[15], 2.00000))/(Math.pow(CONSTANTS[35], 2.00000)+Math.pow(STATES[15], 2.00000))+CONSTANTS[36])*STATES[10]*STATES[16];
ALGEBRAIC[63] = CONSTANTS[39]/(1.00000+Math.pow(CONSTANTS[37], 2.00000)/Math.pow(STATES[3], 2.00000));
...
ALGEBRAIC[67] = 1.00000/(1.00000+( CONSTANTS[40]*CONSTANTS[41])/Math.pow(STATES[3]+CONSTANTS[41], 2.00000));
RATES[3] =  ALGEBRAIC[65]*ALGEBRAIC[67];
ALGEBRAIC[66] =  (CONSTANTS[4]/CONSTANTS[44])*(ALGEBRAIC[63] - (ALGEBRAIC[62]+ALGEBRAIC[64]));
ALGEBRAIC[68] = 1.00000/(1.00000+( CONSTANTS[42]*CONSTANTS[43])/Math.pow(STATES[15]+CONSTANTS[43], 2.00000));
