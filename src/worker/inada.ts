...
ALGEBRAIC[65] = (Math.abs(STATES[0]) < 1e-4) ? 
    ((( CONSTANTS[29]*Math.pow(STATES[6], 3.00000)*( 0.635000*STATES[7]+ 0.365000*STATES[8])*CONSTANTS[28]*CONSTANTS[2]))*(Math.exp((0.0 - CONSTANTS[51])/CONSTANTS[48]) - 1.00000)) : 
    ( (( CONSTANTS[29]*Math.pow(STATES[6], 3.00000)*( 0.635000*STATES[7]+ 0.365000*STATES[8])*CONSTANTS[28]*STATES[0]*CONSTANTS[2])/CONSTANTS[48])*(Math.exp((STATES[0] - CONSTANTS[51])/CONSTANTS[48]) - 1.00000))/(Math.exp(STATES[0]/CONSTANTS[48]) - 1.00000);
